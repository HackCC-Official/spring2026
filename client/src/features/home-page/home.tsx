        ...
        <FrontPagePrimaryLayout className="flex bg-bgpurple overflow-x-clip text-white">
            <div className="flex flex-col justify-center items-center mx-auto">
                <div className="relative flex">
                    <Image className="z-10 w-auto h-80 sm:h-80 md:h-80 lg:h-[24rem] 2xl:h-[29rem]" src={Logo} alt="HackCC Logo " priority sizes="(min-width: 1540px) 580px, (min-width: 1024px) 500px, (min-width: 640px) 410px, 310px"></Image>
                ...
                <div className="z-10 flex flex-col -mt-10 mb-6 text-center">
                    <p className="font-bagel text-2xl sm:text-3xl md:text-4xl">May 2026</p>
                    <p className="mt-2 font- font-mont text-base sm:text-lg md:text-xl text-right">Torrance &amp; San Mateo</p>
                </div>
                {/* <Interest></Interest> */}
